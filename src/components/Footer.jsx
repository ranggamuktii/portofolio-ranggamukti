      ...
      <div className="container text-left">
        <div className="lg:grid lg:grid-cols-2">
          <div className="mb-10">
            ...
            <ButtonPrimary href="mailto:daniswara.ranggamukti@gmail.com" label="Rangga Mukti" icon="chevron_right" />
          </div>
        ...
        <div className="flex items-center justify-between pt-10 mb-8">
          ...
          <p className="text-zinc-500 text-sm">
            @copy; 2025 <span className="text-zinc-200">ranggamukti</span>
          </p>
        </div>
      </div>
    </footer>
